...
class TermController extends Controller
{
    ...
    {
        return $this->render('term/index.html.twig', ['terms' => $termRepository->findAll()]);
    }
    ...
    {
        return $this->render('term/show.html.twig', ['term' => $term]);
    }
    ...
    public function edit(Request $request, Term $term): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('term_edit', ['id' => $term->getId()]);
        }
